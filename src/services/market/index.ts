...
import { marketRoutes } from '../../api/routes';
import {
...
export class Market {
  static async testConnectivity() {
    return await request({ url: marketRoutes.GET_PING });
  }

  static async checkServerTime() {
    return await request({ url: marketRoutes.GET_SERVER_TIME });
  }

  static async exchangeInfo(params: SymbolSymbolsParams) {
    return await request({ url: marketRoutes.GET_EXCHANGE_INFO, params });
  }

  static async orderBook(params: SymbolLimitParams) {
    return await request({ url: marketRoutes.GET_ORDER_BOOK, params });
  }

  static async recentTrades(params: SymbolLimitParams) {
    return await request({ url: marketRoutes.GET_RECENT_TRADES, params });
  }

  static async compressedTrades(params: CompressedTradesParams) {
    return await request({ url: marketRoutes.GET_COMPRESSED_TRADES, params });
  }

  static async klines(params: KlinesParams) {
    return await request({ url: marketRoutes.GET_KLINES, params });
  }

  static async continuousKlines(params: ContinuousKlinesParams) {
    return await request({ url: marketRoutes.GET_CONTINUOUS_KLINES, params });
  }

  static async markPriceKlines(params: KlinesParams) {
    return await request({ url: marketRoutes.GET_MARK_PRICE_KLINES, params });
  }

  static async markPrice(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_MARK_PRICE, params });
  }

  static async fundingRateHistory(params: SymbolLimitTimeParams) {
    return await request({ url: marketRoutes.GET_FUNDING_RATE_HIST, params });
  }

  static async get24hTickerPrice(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_24H_TICKER_PRICE, params });
  }

  static async symbolPriceTicker(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_PRICE_TICKER, params });
  }

  static async symbolOrderBookTicker(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_ORDER_BOOK_TICKER, params });
  }

  static async openInterest(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_OPEN_INTEREST, params });
  }

  static async openInterestStatistics(params: SymbolLimitTimePeriodParams) {
    return await request({ url: marketRoutes.GET_OPEN_INTEREST_HIST, params });
  }

  static async topLongShortAccountRatio(params: SymbolLimitTimePeriodParams) {
    return await request({
      url: marketRoutes.GET_TOP_LONG_SHORT_ACC_RATIO,
      params,
    });
  }
  ...
  static async topLongShortPositionRatio(params: SymbolLimitTimePeriodParams) {
    return await request({
      url: marketRoutes.GET_TOP_LONG_SHORT_POS_RATIO,
      params,
    });
  }
  ...
  static async globalLongShortAccountRatio(
    ...
    return await request({
      url: marketRoutes.GET_GLOBAL_LONG_SHORT_ACC_RATIO,
      params,
    });
  }
  ...
  static async topTraderLongShortRatio(params: SymbolLimitTimePeriodParams) {
    return await request({
      url: marketRoutes.GET_TAKER_LONG_SHORT_RATIO,
      params,
    });
  }

  static async compositeIndexSymbolInfo(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_INDEX_INFO, params });
  }

  static async multiAssetsModeAssetIndex(params: OptionalSymbolParams) {
    return await request({ url: marketRoutes.GET_ASSET_INDEX, params });
  }
}
